...
public class SqlManager {
    ...
    public static void createTable(String name) {
        try {
            String sql = "CREATE TABLE IF NOT EXISTS " + name + " (ID TEXT PRIMARY KEY, STRINGS TEXT, INTS TEXT, FLOATS TEXT, DOUBLES TEXT, BOOLEANS TEXT, JSON TEXT, NBT TEXT, BLOCKPOS TEXT)";
